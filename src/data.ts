export async function getCategories() {
  return [
    { id: 1, name: 'Saúde', date: '05/03/2026' },
    { id: 2, name: 'Alimentação', date: '05/03/2026' },
    { id: 3, name: 'Supermercado', date: '05/03/2026' },
    { id: 4, name: 'Cinema', date: '05/03/2026' },
    { id: 5, name: 'Viagem', date: '05/03/2026' },
  ]
}

export async function getCategory(id: string) {
  return (await getCategories()).find((category) => category.id.toString() === id)!
}

export async function getBudgetList() {
  return [
    { id: 1, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 2, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 3, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 4, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 5, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 6, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 7, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
    { id: 8, agency: '0000-0', account: '0000', category: { id: 1, name: 'Saúde' }, budgetAmount: 99.99 },
  ]
}

export async function getBudget(id: string) {
  return (await getBudgetList()).find((budget) => budget.id.toString() === id)!
}
...
export async function getTransaction(id: string) {
  return (await getTransactions()).find((transaction) => transaction.id.toString() === id)!
}

export async function getRecentTransactions() {
  return (await getTransactions()).slice(0, 10)
}
